    ...
    >
      ...
      <div className="relative z-10 flex flex-col justify-end items-start gap-10 md:gap-16 lg:flex-row lg:gap-20 w-full ">
        ...
        >
          ...
          <p className="text-white max-w-450px md:max-w-550px lg:max-w-700px md:text-lg 2xl:text-xl">
        ...
        >
          ...
          <p className="text-white max-w-450px md:max-w-550px lg:max-w-700px text-base md:text-lg 2xl:text-xl text-justify">
